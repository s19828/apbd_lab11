            ...
            modelBuilder.Entity("LAB_11.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            Birthdate = new DateTime(2025, 5, 25, 18, 8, 1, 705, DateTimeKind.Local).AddTicks(2887),
                            FirstName = "Cn",
                            LastName = "Cl"
                        },
                        new
                        {
                            IdPatient = 2,
                            Birthdate = new DateTime(2025, 5, 25, 18, 8, 1, 706, DateTimeKind.Local).AddTicks(7833),
                            FirstName = "Dn",
                            LastName = "Dl"
                        });
                });
            ...
            modelBuilder.Entity("LAB_11.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2025, 5, 25, 18, 8, 1, 706, DateTimeKind.Local).AddTicks(8944),
                            DueDate = new DateTime(2025, 5, 25, 18, 8, 1, 706, DateTimeKind.Local).AddTicks(9057),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2025, 5, 25, 18, 8, 1, 706, DateTimeKind.Local).AddTicks(9350),
                            DueDate = new DateTime(2025, 5, 25, 18, 8, 1, 706, DateTimeKind.Local).AddTicks(9354),
                            IdDoctor = 2,
                            IdPatient = 2
                        });
                });
